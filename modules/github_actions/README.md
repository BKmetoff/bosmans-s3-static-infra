...
| <a name="input_oidc_arn"></a> [oidc\_arn](#input\_oidc\_arn) | ARN of the s3 bucket | `string` | n/a | yes |
...
| <a name="input_staging"></a> [staging](#input\_staging) | Weather GH should upload to s3 staging bucket | `bool` | `false` | no |
